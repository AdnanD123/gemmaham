                    ...
                    <main className="flex-1 p-6 max-w-5xl">
                        ...
                        <ContentLoader loading={loading} skeleton={
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {[1, 2, 3].map((i) => (
                                    <div key={i} className="bg-surface rounded-2xl border border-foreground/6 p-5">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {assignments.map((a) => (
                                        <Link
                                            ...
                                            className="bg-surface rounded-2xl border border-foreground/6 p-5 hover:border-primary/30 transition-colors"
                                        >
