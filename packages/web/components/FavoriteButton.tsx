...
const FavoriteButtonInner = memo(({
  ...
  return (
    <motion.button
      ...
      className="absolute top-2 right-2 z-10 flex items-center justify-center w-8 h-8 rounded-full bg-surface/80 backdrop-blur-sm border border-foreground/6 shadow-card hover:bg-surface transition-colors cursor-pointer"
